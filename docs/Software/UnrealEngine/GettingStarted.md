---
title: Getting Started with Unreal Engine - Alchemize
...
![Unreal Engine Template]({0E51FDB4-4E32-43D1-8E58-0B43E1501D1E}.png)
3. Set your project to **Blueprint** (easier for beginners) or **C++**.
4. Choose a project name and folder.
![Unreal Engine Create Project]({74F5B42F-F24E-4997-A341-48EEDD0F1963}.png)
5. Click **Create**.
